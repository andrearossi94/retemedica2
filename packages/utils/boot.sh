...
node register.js dottore1 dottore ortopedico mr1976 mario123
node register.js dottore2 dottore cardiologo gc1996 giacomo123
node register.js paziente1 paziente gs1986 giuseppe123
node register.js paziente2 paziente mr1976 mario123
echo "FINE"
...
hurl invoke cartellaclinica cartellaclinica_create "{ \"id\": \"Cart1\", \"pazienteID\": \"Paz1\", \"dottoreID\": \"Dot1\", \"patologia\": \"Frattura\",\"stato\": true, \"consenso\": true }" "mr1976" "mario123" -u dottore1
hurl invoke cartellaclinica cartellaclinica_create "{ \"id\": \"Cart2\", \"pazienteID\": \"Paz2\", \"dottoreID\": \"Dot2\", \"patologia\": \"Trauma\", \"stato\": true, \"consenso\": true }" "gs1986" "giuseppe123" -u dottore2
echo "FINE"